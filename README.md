Octopus is to make it easy to execute shells in different machines at once by ssh,easy to rollback and gathering of information from multiple machines.
